...
const data = [
    {date: 'Fri, May 19', time: '8:30pm AEDT', match: 'ROUND 18', location: 'Nissan Arena'},
    {date: 'Sat, May 26', time: '4:30pm AEDT', match: 'ROUND 19', location: 'Spark Arena'},
    {date: 'Sun, Jun 02', time: '6:30pm AEDT', match: 'ROUND 20', location: 'Qudos Bank Arena'},
    {date: 'Fri, Jun 11', time: '8:30pm AEDT', match: 'ROUND 21', location: 'Nissan Arena'}
]
...
const mockTeams = [
    ...
    }, {img: require('../../assets/teamImages/nz.png'), team: 'New Zealand Breakers'}, {
        img: require('../../assets/teamImages/BB.png'),
        team: 'Brisbane Bullets'
    }
]
