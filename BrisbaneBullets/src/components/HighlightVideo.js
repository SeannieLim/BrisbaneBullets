            ...
            <TouchableOpacity onPress={handleVideoCardPress}>
                <Box style={{...styles.box, ...styles.videoCardContainer}} bg='#164CA8' rounded={15}>
                    <Box position='relative'>
                        ...
                        <AntDesign name="playcircleo" size={45} color="white" position='absolute' bottom={'45%'}
                                   right={'45%'}/>
                        <LinearGradient colors={['rgba(0, 0, 0, 0)', 'rgba(22, 76, 168, 0.9)']} position='absolute'
                                        bottom={0} left={0} right={0} style={styles.gradientContainer}>
