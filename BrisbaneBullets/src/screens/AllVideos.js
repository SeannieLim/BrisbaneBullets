...
const mockVideos = [
  {
    id: 1,
    title:
      "New Zealand Breakers vs. Brisbane Bullets - Game Highlights - Round 20, NBL24",
    date: "Feb 16, 2024",
  ...
  },
  {
    id: 3,
    title:
      "Brisbane Bullets vs. Adelaide 36ers - Game Highlights - Round 19, NBL24",
    date: "Feb 09, 2024",
  ...
  },
  {
    id: 5,
    title:
      "Illawarra Hawks vs. Brisbane Bullets - Game Highlights - Round 18, NBL24",
    date: "Feb 03, 2024",
  ...
  return (
    <View style={styles.videoContainer}>
      <TouchableOpacity onPress={handlePress} style={styles.video}>
        <ImageBackground source={video.img} style={styles.imageBackground} />
